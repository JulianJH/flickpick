      ...
      >
        <div className="flex items-center justify-center gap-3 mb-6">
          <motion.div
            ...
            className="w-16 h-24 rounded-none bg-lb-card border border-lb-border flex items-center justify-center text-2xl"
          >
            ↑
          </motion.div>
          <motion.div
        ...
        <button
          onClick={onDismiss}
          className="w-full bg-lb-accent hover:bg-lb-accent-dim text-white font-bold py-3.5 rounded-none text-sm transition-colors"
        >
          Got it →
        </button>
      </motion.div>
