    ...
    <div className="min-h-dvh bg-lb-bg flex flex-col items-center justify-center px-6 py-12">
      ...
      >
        ...
        <motion.div
          ...
          className="mx-auto w-48 rounded-none overflow-hidden shadow-2xl shadow-black/60 border border-lb-border mb-6"
        >
          {winner.posterPath ? (
        ...
        >
          ...
          <button
            onClick={onHome}
            className="w-full bg-lb-card border border-lb-border text-lb-text-dim font-semibold py-3 rounded-none text-sm hover:text-lb-text transition-colors"
          >
            Start Over
          </button>
        </motion.div>
